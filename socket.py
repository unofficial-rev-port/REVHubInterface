# SOCKET.PY SUSSY VERSION
# I deleted some imports to make it not error
# some of them werent the right ones and i didnt fix it
# so if this is giving you weird errors decomp it again
